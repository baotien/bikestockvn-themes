...
.fb_iframe_widget {
	...
	.vc_custom_1497331706771 .vc_single_image-wrapper {
		width: 320px;
	}
	.vc_custom_1497331706771 .vc_single_image-img  {
		width: 320px;
	}
...
?>
<div class="widget-mobile-footer">
...
<div class="row visible-xs hidden-md hidden-lg div_no_mr_mb">
	<div class="container">
		<div class="footer-menu-dropdown">
			<?php wp_nav_menu( array( 'theme_location' => 'hidden-menu' ) ); ?>
		</div>
	</div>
</div>
...
<div id="footer" class="footer-1<?php if ($porto_settings['footer-ribbon']) echo ' show-ribbon' ?>"<?php if ($porto_settings['footer-parallax']) echo ' data-plugin-parallax data-plugin-options="{&quot;speed&quot;: ' . esc_attr($porto_settings['footer-parallax-speed']) . '}" style="background-image: none !important;"' ?>>
                ...
                if ($cols) :
                    ...
                    switch ($cols) {
                        ...
                        case 3:
                            ...
                            $col_class[1] = 'col-md-' . (($porto_settings['footer-customize'] && $porto_settings['footer-widget1']) ? $porto_settings['footer-widget1'] : '4');


                            $col_class[2] = 'col-md-' . (($porto_settings['footer-customize'] && $porto_settings['footer-widget2']) ? $porto_settings['footer-widget2'] : '4');
                        ...
                        case 4:
                            ...
                            $col_class[3] = 'col-md-' . (($porto_settings['footer-customize'] && $porto_settings['footer-widget3']) ? $porto_settings['footer-widget3'] : '3');


                            $col_class[4] = 'col-md-' . (($porto_settings['footer-customize'] && $porto_settings['footer-widget4']) ? $porto_settings['footer-widget4'] : '3');
    ...
    if (($porto_settings['footer-logo'] && $porto_settings['footer-logo']['url']) || is_active_sidebar( 'footer-bottom-remove' ) || $porto_settings['footer-copyright']) :
    //var_dump( $porto_settings['footer-copyright'])
    //if ( $porto_settings['footer-copyright']) :
    ...
    <div class="footer-bottom">
        ...
        <div class="container">
            ...
            <?php if (($porto_settings['footer-logo'] && $porto_settings['footer-logo']['url']) || $porto_settings['footer-copyright-pos'] == 'left' || ($porto_settings['footer-copyright-pos'] == 'right' && is_active_sidebar( 'footer-bottom-remove' ))) : ?>
            ...
            <div class="footer-left">
                ...
                } else if ($porto_settings['footer-copyright-pos'] == 'right' && is_active_sidebar( 'footer-bottom-remove' )) {


                        dynamic_sidebar( 'footer-bottom-remove' );
            ...
            <?php } else if ($porto_settings['footer-copyright-pos'] == 'left' && is_active_sidebar( 'footer-bottom-remove' )) { ?>


                <div class="footer-right"><?php dynamic_sidebar( 'footer-bottom-remove' ); ?></div>
