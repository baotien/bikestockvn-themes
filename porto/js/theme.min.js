/* Plugin Name: 	BrowserSelector Written by: 	Okler Themes - (http://www.okler.net) Version: 		4.9.1 */
        ...
        return this.each(function() {
            ...
            h ? i.find("*").addBack().each(function() {
                ...
                b.is("img:uncached") && j.push({
                    ...
                    var f, e = b.attr(d);
                    return !e || (f = e.split(","), void a.each(f, function(c, d) {
...
var RtlDetectLib = {
    ...
    _parseLocale: function(a) {
        var e, f, g, b = this,
            c = /^([a-zA-Z]*)([_\-a-zA-Z]*)$/,
            d = c.exec(a);
        if (a && d) return d[2] = b._trim(d[2], ["-", "_"]), f = b._toLowerCase(d[1]), g = b._toUpperCase(d[2]) || g, e = {
            lang: f,
            countryCode: g
        }
    },
...
Object.defineProperty(RtlDetectLib, "_BIDI_RTL_LANGS", {
        ...
        a = a || {}, b.extend(a, {
            ...
            mfpConfig: {
                ...
                callbacks: {
                    ...
                    close: function() {
                        ...
                        var c = this.st.fixedContentPos;
                        c && b("#header.sticky-header .header-main.sticky, #header.sticky-header .main-menu-wrap, .fixed-header #header.sticky-header .header-main, .fixed-header #header.sticky-header .main-menu-wrap").css(a.rtl_browser ? "left" : "right", ""), b(".owl-carousel .owl-stage").each(function() {
                            var a = b(this),
            ...
            scrolltoContainer: function(c) {
                if (c.get(0)) {
                    ...
                    d <= 991 - a.getScrollbarWidth() && b(".sidebar-overlay").click(), b("html, body").stop().animate({
        ...
        d.defaults.responsive[0] = {
            ...
            build: function() {
                ...
                var q, d = this.options.wrapper,
                    ...
                    p = {},
                    r = d.find("> *").length;
                if (n ? q = 1 : (q = this.options.items ? this.options.items : j ? j : 1, p[i] = {
                        items: q,
                        loop: !!(e && r > q),
    ...
    function(a, b) {
        ...
        d.prototype = {
            ...
            getLoaderClass: function(a) {
                ...
                return b = g(a), c = parseInt(b.substr(0, 2), 16), d = parseInt(b.substr(2, 2), 16), e = parseInt(b.substr(4, 2), 16), f = (299 * c + 587 * d + 114 * e) / 1e3, f >= 128 ? "black" : "white"
            }
        }, b.extend(a, {
            LoadingOverlay: d
        ...
        d.defaults = {}, d.prototype = {
            ...
            build: function() {
                ...
                return d.hasClass("active") && d.find("> div.toggle-content").stop().slideDown(350, function() {
                    ...
                    g && "undefined" != typeof c.originalEvent && e.find("section.toggle.active > label").trigger("click"), d.hasClass("active") ? f.length && "one-toggle" == f.data("view") || (h.stop().slideUp(350, function() {
    ...
    function(a, b) {
        ...
        d.defaults = {
            ...
            build: function() {
                var d, e, f, a = this,
                    c = b(window);
                return a.options.wrapper.removeAttr("style"), "undefined" != typeof a.options.wrapper.data("image-src") && a.options.wrapper.css("background-image", "url(" + a.options.wrapper.data("image-src") + ")"), b.browser.mobile ? a.options.wrapper.addClass("parallax-disabled") : (c.on("scroll resize", function() {
            ...
            build: function() {
                ...
                return d.click(function(c) {
                    ...
                    if ("true" == e) {
                        ...
                        var l = {};
                        l.src = b(this).attr("href"), l.title = b(this).attr("data-title"), f[g] = l, i = {
                            index: 0,
                            event: c
                        }
                    }
                ...
                reset: function() {
                    ...
                    if (a.isTablet()) c.$side_nav.attr("style", "");
                        ...
                        var e = navigator.appVersion,
                            ...
                            g = f + 3,
                            h = e.slice(f, g);
                        h < 537 && (c.$side_nav.css("-webkit-backface-visibility", "hidden"), c.$side_nav.css("-webkit-perspective", "1000"))
                    }
                ...
                activeMenuItem: function() {
                    ...
                    return e.length && e.each(function() {
                        ...
                        if (0 == e.indexOf("#")) f = b(e);
                            ...
                            g = g.substring(g.indexOf("://") + 3), g.indexOf("#") != -1 && (g = g.substring(0, g.indexOf("#"))), e = e.substring(e.indexOf("://") + 3), e = e.substring(e.indexOf(g) + g.length), 0 == e.indexOf("#") && (f = b(e))
                        }
                        if (f && f.get(0)) {
                ...
                events: function() {
                    ...
                    return b('.menu-item > a[href*="#"], .porto-sticky-nav .nav > li > a[href*="#"], a[href*="#"].hash-scroll, .hash-scroll-wrap a[href*="#"]').on("click", function(d) {
                        ...
                        if (0 == f.indexOf("#")) g = b(f);
                            ...
                            h = h.substring(h.indexOf("://") + 3), h.indexOf("#") != -1 && (h = h.substring(0, h.indexOf("#"))), f = f.substring(f.indexOf("://") + 3), f = f.substring(f.indexOf(h) + h.length), 0 == f.indexOf("#") && (g = b(f))
                        }
                        if (g && g.get(0)) {
                            var i = e.parent(),
                            ...
                            var e = b(this),
                                f = {
                                    ...
                                    show: function(d) {
                                        ...
                                        return e.$ajaxBoxContent.empty(), e.$ajaxBox.removeClass("ajax-box-init").addClass("ajax-box-loading"), a.scrolltoContainer(e.$ajaxBox), e.currentPage = d, d < 0 || d > e.total - 1 ? (e.close(), !1) : void b.ajax({
                                            url: e.pages[d],
                                            complete: function(d) {
                        ...
                        if (d.find("a[data-ajax-on-modal]").get(0)) {
                            var e = b(this),
                                f = {
                                    ...
                                    show: function(d) {
                                        var e = this;
                                        return e.currentModal = d, !(d < 0 || d > e.total - 1) && (b.magnificPopup.close(), void b.magnificPopup.open(b.extend(!0, {}, a.mfpConfig, {
                                            type: "ajax",
                                            items: e.modals,
                                            gallery: {
                                                enabled: !0
        ...
        var refreshPriceSlider = function() {
            ...
            ajaxFiltered = function() {
                var a = ".shop-loop-before",
                    b = ".shop-loop-after",
                    c = ".archive-products .products",
                    d = $(a).parent(),
                    e = $(".sidebar [data-plugin-sticky]");
                e.get(0) && d.css("min-height", 0), $(a + "," + b).get(0) && $(a + "," + b).stop(!0).fadeTo("400", "1").unblock(), $(c).find(".product").get(0) ? $(a + "," + b).show().data("show", !0) : $(a + "," + b).hide().data("show", !1), porto_init(), $(".woocommerce-ordering").off("change", "select.orderby").on("change", "select.orderby", function() {
                    $(this).closest("form").submit()
        ...
        $(function() {
            "undefined" != typeof yith_wcan && (yith_wcan.container = ".archive-products .products", yith_wcan.pagination = ".shop-loop-before", yith_wcan.result_count = ".shop-loop-after"), $(document).on("click", ".yith-wcan a", function(a) {
                var b = ".shop-loop-before",
                    ...
                    e = ".archive-products .woocommerce-info",
                    f = $(b).parent(),
                    g = $(".sidebar [data-plugin-sticky]"),
                    h = $(b).data("show");
                h && $(b + "," + c).stop(!0).show().fadeTo("400", "0.8").block({
                    message: null,
                    overlayCSS: {
                        opacity: .6
                    }
                }), $(d).length ? $(d).html("").addClass("yith-wcan-loading") : $(e).html("").addClass("yith-wcan-loading products"), g.get(0) && (f.css("min-height", g.height()), theme.refreshStickySidebar(!1)), $(".yith-woo-ajax-navigation, .yith-wcan-list-price-filter").addClass("loading"), theme.scrolltoContainer($(h ? b : d))
                            ...
                            if (d.owlCarousel({
                                    ...
                                    onRefreshed: function() {
                                        !a.product_zoom || "ontouchstart" in document && !("ontouchstart" in document && a.product_zoom_mobile) || d.find("img").each(function() {
                                            ...
                                            "undefined" != typeof d && (d.startZoom(), d.swaptheimage(c, c))
                                        })
                                    }
                                }), d.data("links", g), a.product_image_popup) {
                                var l = d.next();
                                l.off("click").on("click", function(c) {
                                    c.preventDefault();
                ...
                selectThumb: function(a, e, f) {
                    if (!d) {
                        ...
                        f = (f + g) % g, a && a.trigger("to.owl.carousel", [f, c, !0]), e.find(".owl-item").removeClass("selected"), e.find(".owl-item:eq(" + f + ")").addClass("selected"), e.data("currentThumb", f), e.find(".owl-item.active").each(function() {
                            h[i++] = b(this).index()
                        }), b.inArray(f, h) == -1 && (Math.abs(f - h[0]) > Math.abs(f - h[h.length - 1]) ? e.trigger("to.owl.carousel", [(f - h.length + 1) % g, c, !0]) : e.trigger("to.owl.carousel", [f % g, c, !0])), d = !1
                    }
                }
            }
        })
                        ...
                        return b.fancybox({
                            ...
                            onUpdate: function() {
                                setTimeout(function() {
                                    ...
                                    "undefined" != typeof a.data("owl.carousel") && "undefined" != typeof a.data("owl.carousel")._invalidated && (a.data("owl.carousel")._invalidated.width = !0), a.trigger("refresh.owl.carousel")
                                }, 300)
                            }
                        }), !1
                    }), c
            ...
            WooVariationForm: {
                ...
                events: function() {
                    ...
                    return b(".variations_form").each(function() {
                        ...
                        }), "undefined" != typeof m && (m[0].src = h, m[0].title = g)), j && i.attr("src", j)
                        ...
                        if ("undefined" != typeof d) {
                            ...
                            var h = f.data("links"),
                                ...
                                q = d.image_title,
                                r = d.image_thumb;
                            j || (j = i.attr("src") ? i.attr("src") : "", i.attr("data-o_src", j)), l || (l = i.attr("href") ? i.attr("href") : "", i.attr("data-o_href", l)), k || (k = i.attr("alt") ? i.attr("alt") : "", i.attr("data-o_title", k)), n || (n = m.attr("src") ? m.attr("src") : "", m.attr("data-o_src", n)), o ? (i.attr("src", o), i.attr("srcset", ""), i.attr("alt", q), i.attr("href", p), m.attr("src", r), "undefined" != typeof h && (h[0].src = p, h[0].title = q)) : (i.attr("src", j), i.attr("srcset", ""), i.attr("alt", k), i.attr("href", l), m.attr("src", n), "undefined" != typeof h && (h[0].src = l, h[0].title = k)), i.each(function() {
                                var a = b(this).data("elevateZoom");
                                "undefined" != typeof a && a.swaptheimage(b(this).attr("src"), b(this).attr("src"))
                            })
                        }
    ...
    function(a, b) {
        ...
        b(document).ready(function() {
            ...
            var c = window.navigator.userAgent,
                d = c.indexOf("Edge/") > 0;
            if (d && b("html").addClass("ie12"), !b("#yith-wcwl-popup-message").get(0)) {
    ...
    function(a, b, c) {
        "use strict";
        "undefined" != typeof a.WooVariationForm && a.WooVariationForm.initialize(), "undefined" != typeof a.WooProductImageSlider && a.WooProductImageSlider.initialize(), b(document).ready(function() {
