...
function porto_edit_product_cat_meta_fields($tag, $taxonomy) {	return;
...
function porto_save_product_cat_meta_values($term_id, $tt_id, $taxonomy) {	return;
    if ($taxonomy !== 'product_cat') return;
...
function porto_delete_product_cat_meta_values($term_id, $tt_id, $taxonomy, $deleted_term, $object_ids) {	return;
    if ($taxonomy !== 'product_cat') return;
