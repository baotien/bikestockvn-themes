    ...
    <?php } else if ($banner_type === 'rev_slider' && isset($rev_slider)) { ?>
        ...
        <div class="banner-container">
            ...
            <div id="banner-wrapper" class="<?php echo $banner_class ?>">
                ...
                <?php echo do_shortcode('[shortcode_slider_ct]'); ?>
...
function porto_minicart() {
    ...
    if ( class_exists( 'WooCommerce' ) ) :
        ...
        <div id="mini-cart" class="dropdown mini-cart <?php echo $minicart_type ?><?php echo ($porto_settings['minicart-effect']?' '.$porto_settings['minicart-effect']:'') ?><?php echo ( $porto_settings['minicart-popup-style'] == '2' ) ? ' minicart-style2' : ' minicart-style1'; ?>">
