...
?>
		...
		<h1 class="heading-primary font-weight-normal"><?php _e( 'Tạo tài khoản', 'porto' ); ?></h1>
		
        <div class="featured-box align-left">
            <div class="box-content">

                <h2><?php _e( 'THÔNG TIN CÁ NHÂN', 'porto' ); ?></h2>
                ...
                <form method="post" class="register">
					...
					<h2><?php _e( 'THÔNG TIN ĐĂNG NHẬP', 'porto' ); ?></h2>
                    ...
                    <div class="woocommerce-FormRow form-row clearfix">
						<p class="required pull-right"><?php _e( '* Trường bắt buộc', 'porto' ); ?></p>
                    </div>
					
					<div class="woocommerce-FormRow form-row clearfix">
                        <?php wp_nonce_field( 'woocommerce-register', 'woocommerce-register-nonce' ); ?>
						<?php if( isset( $_SERVER['HTTP_REFERER'] ) && $_SERVER['HTTP_REFERER'] ): ?>
							<a href="<?php echo get_permalink( woocommerce_get_page_id( 'myaccount' ) ); ?>" class="pull-left"><i class="fa fa-angle-double-left"></i> <?php _e( 'Trở lại', 'porto' ); ?></a>
						<?php endif; ?>
                        <input type="submit" class="woocommerce-Button button pull-right" name="register" value="<?php esc_attr_e( 'GƯI', 'porto' ); ?>" />
                    </div>
